...
```
storefront-next/src/extensions/noibu/
├── adapters/
...
| Location | Purpose |
|---|---|
| `sfcc-storefront/src/extensions/noibu/` | Active development, local testing |
| `commerce-apps/analytics/noibu/commerce-noibu-app-v1.0.0/storefront-next/src/extensions/noibu/` | Commerce App package source |

After every change in `sfcc-storefront`, sync to the package:

```bash
cp sfcc-storefront/src/extensions/noibu/adapters/noibu-adapter.ts \
   commerce-apps/analytics/noibu/commerce-noibu-app-v1.0.0/storefront-next/src/extensions/noibu/adapters/noibu-adapter.ts
```

### Running tests

From `sfcc-storefront/`:

```bash
pnpm test src/extensions/noibu          # run once
pnpm test:watch src/extensions/noibu   # watch mode
```
